...
console.log('esercizio2:', characters);
...
console.log('esercizio4:', eyeColor);
...
//starWarsCharacters[2].mass = '2777' // da usare per cambiare massa a un personaggio e verificare esercizio 7

let i = 0
let massaTotale = 0

while (i < starWarsCharacters.length) {
  const massa = parseInt(starWarsCharacters[i].mass)
...
// while (massaTotale < starWarsCharacters.mass) {
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  console.log('esercizio8:', starWarsCharacters[i].gender)
}
